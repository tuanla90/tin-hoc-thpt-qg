...
function danhSachTep() {
  ...
  const boQua = /vendor\/|\/app\.js$|account\.js$|exam-modes\.js$|profile\.js$|skills\.js$|session\.js$|tutor\.js$|nhiem-vu\.js$|skulpt-lazy\.js$|pwa\.js$|on-nhanh\.js$|nhac\.js$|am-thanh\.js$|minh-hoa(-\d)?\.js$/;
