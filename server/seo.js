...
function baiCoMinhHoa() {
  ...
  MH_CO = new Set();
  ["minh-hoa.js", "minh-hoa-2.js", "minh-hoa-3.js", "minh-hoa-4.js", "minh-hoa-5.js", "minh-hoa-6.js"].forEach((ten) => {
    try {
...
/* Khối minh hoạ trên trang công khai.
   Trang này CỐ Ý không nạp bundle của app (nặng ~1,2MB). Sáu tệp minh hoạ thì
