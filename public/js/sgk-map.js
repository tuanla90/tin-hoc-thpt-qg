/* ============================================================================
 *  ĐỐI CHIẾU BÀI CỦA ỨNG DỤNG VỚI SÁCH GIÁO KHOA — bộ KẾT NỐI TRI THỨC.
 *
 ...
 *
 *  Nguồn: tên bài và số trang chép từ chính sách (bản đối chiếu làm hồi còn
 *  nhánh bám SGK, lấy lại từ lịch sử git), ghép với bảng ánh xạ nội dung do
 *  sub-agent đối chiếu. MỘT bài SGK trỏ tới ĐÚNG MỘT bài của app; ngược lại
 *  một bài của app có thể gộp nhiều bài SGK.
 *
 ...
 *  dễ học. Vì vậy giao diện chỉ hiện đối chiếu khi CÓ, tuyệt đối không gắn
 *  nhãn "ngoài SGK" cho phần còn lại.
 *
 *  CHƯA CÓ: nhánh Tin học ứng dụng (U11-*, U12-*) vì chưa có sách; hai bộ
 *  Cánh Diều và Chân trời sáng tạo cho lớp 10, 11.
 * ==========================================================================*/
var SGK_MAP = {
  bo: "kntt",
  ...
  sach: {
    ...
    11: {
      ten: "Tin học 11 — Khoa học máy tính",
      bai: [
    ...
    12: {
      ten: "Tin học 12 — Khoa học máy tính",
      bai: [
